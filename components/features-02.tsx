        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              At InspiredCoders, we take app development to a whole new level
              with our smarter and faster apps. Our team of skilled developers
              harnesses cutting-edge technologies and innovative design
              principles to create intelligent and responsive applications that
                        ...
                        <div className="mb-5">
                          <div>
                            <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">
                              Intelligent Solutions, Swift Results
                            </h3>
                            <p className="text-slate-400">
                              Our apps leverage cutting-edge technologies to
                              deliver intelligent functionalities and
                              lightning-fast performance, giving your users an
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">
                            Smart Apps, Faster Success
                          </h3>
                          <p className="text-slate-400">
                            Boost your productivity and efficiency with our
                            smartly crafted apps that accelerate your business
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Experience the seamless fusion of intelligent
                            features and rapid response times in our apps,
                            optimizing your workflows and delighting your
                            audience.
                          </p>
                        </div>
                      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Ensure that the websites created by your company are responsive
                and adapt seamlessly to different devices and screen sizes. This
                feature is crucial for providing a consistent and user-friendly
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Develop websites that are compatible with various web browsers,
                including Chrome, Firefox, Safari, Edge, and others. Ensuring
                compatibility ensures that users have a consistent experience
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Implement SEO best practices during web development to help
                clients' websites rank higher in search engine results. This
                includes optimizing page load times, using proper meta tags, and
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Offer CMS integration so that clients can easily update and
                manage their website content without requiring technical
                expertise. Popular CMS options include WordPress, Joomla,
                Drupal, etc.
              </p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Security Measures</h4>
              </div>
              <p className="text-sm text-slate-400">
                Prioritize website security by implementing SSL certificates,
                protecting against common vulnerabilities, and keeping software
                up to date. Assure your clients that their data and users'
                information are safe and protected.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-400">
                Integrate website analytics tools to track and measure the
                website's performance, user behavior, and traffic. Provide
                clients with detailed reports to help them make informed
                decisions and optimize their online presence.
              </p>
            </div>
          </div>
        </div>
